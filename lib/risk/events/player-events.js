...
module.exports = {
    ...
    REQUIRE_ONE_UNIT_DEPLOY: {
        ...
        message: data => `You must place 1 unit on one of your territories.`,
        data: {
    ...
    REQUIRE_PLACEMENT_ACTION: {
        ...
        message: data => `You must deploy ${data.units} units on your territories.`,
        data: {
            units: 'The number of units you can deploy.',
            territoryIds: 'The territories of this player.'
        },
        required: ['units', 'territoryIds']
    },
