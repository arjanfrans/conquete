...
class Game {
    ...
    start () {
        ...
        let previousTurnEvent = Object.assign({}, this.state.previousTurnEvent);
        let previousPlayerEvent = Object.assign({}, this.state.previousPlayerEvent);
        ...
        if (previousTurnEvent && previousTurnEvent.name !== EVENTS.TURN_CHANGE &&
                previousTurnEvent.name !== EVENTS.GAME_START) {
