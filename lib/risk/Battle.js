...
class Battle {
    ...
    get attacker () {
        return this.from.occupyingPlayer;
    }

    get defender () {
        return this.to.occupyingPlayer;
    }
    ...
    _compareResult () {
        ...
        debug('defender units killed', defendKilled);
        debug('attacker units killed', attackKilled);

        this.attackUnits -= attackKilled;
        this.defendUnits -= defendKilled;

        debug('defender units left', this.defendUnits);
        debug('attacker units left', this.attackUnits);
